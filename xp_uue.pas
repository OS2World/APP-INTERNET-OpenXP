...
{ --------------------------------------------------------------- }
{ $Id: xp_uue.pas,v 1.7 2002/03/14 23:49:03 rb Exp $ }
...
uses  xpglobal,crt,dos,typeform,fileio,inout,database,maus2,resource,
      xp0,xp1,xp1o,xp1o2,xp1input;
...
begin
  ...
  getmem(outbuf,obufsize);
  if not openinfile(f1^,fn) then
    trfehler(2403,errortimeout)    { 'Kann Datei nicht decodieren.' }
  else begin
...
{
  $Log: xp_uue.pas,v $
  Revision 1.7  2002/03/14 23:49:03  rb
  JG+MY: Fix fÅr UUE-Erkennung

  Revision 1.6  2001/04/04 19:57:04  oh
  -Timeouts konfigurierbar

  Revision 1.5  2000/04/10 22:13:13  rb
  Code aufgerÑumt

  Revision 1.4  2000/04/09 18:34:15  openxp
