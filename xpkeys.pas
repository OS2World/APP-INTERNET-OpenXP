...
{ --------------------------------------------------------------- }
{ $Id: xpkeys.pas,v 1.7 2001/12/22 14:35:57 mm Exp $ }
...
const k0_S  : char = 'S';      { Spezial-Mode         }
      ...
      k2_cD : char = ^D;       { Drucken              }
      k2_cS : char = ^S;       { Datumsanzeige        }
      k2_R  : char = 'r';      { HdrOnly-Req. o. Ausw.}
      ...
      k2_SR : char = 'R';      { HdrOnly-Req. m. Ausw.}
...
{
  $Log: xpkeys.pas,v $
  Revision 1.7  2001/12/22 14:35:57  mm
  ...
  Revision 1.6  2001/07/28 07:52:26  MH
  - Taste 'Ne^w' (englisch) im Specialmode wieder hergestellt

  Revision 1.5  2000/09/24 00:42:06  MH
  Requester nun auf R-Taste (deutsch) und G-Taste (englisch)

  Revision 1.4  2000/04/09 18:31:31  openxp
