...
{ --------------------------------------------------------------- }
{ $Id: mouse.pas,v 1.7 2000/11/15 22:30:10 rb Exp $ }
...
type   mausstat   = record
       ...
       mauststat  = record
                      pressed : boolean;   { momentan gedrÅckt }
...
{$IFDEF BP }
      stsize  : word    = 0;      { Grî·e des Stacks }
{$ENDIF }
...
{
  $Log: mouse.pas,v $
  Revision 1.7  2000/11/15 22:30:10  rb
  Bugfix

  Revision 1.6  2000/07/20 21:14:09  rb
  énderung von MK rÅckgÑngig gemacht

  Revision 1.5  2000/06/08 20:04:54  MH
  Teamname geandert

  Revision 1.4  2000/04/09 18:13:40  openxp
