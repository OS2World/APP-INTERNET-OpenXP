...
{ --------------------------------------------------------------- }
{ $Id: archive.pas,v 1.5 2001/12/27 22:03:44 mm Exp $ }
...
{
  $Log: archive.pas,v $
  Revision 1.5  2001/12/27 22:03:44  mm
  - unnoetige Funktionen entfernt (min, trim und iff gibts schon in unit typeform)
  - Sourceheader aktualisiert

  Revision 1.4  2000/04/09 18:00:40  openxp
