...

{
  ...
  Fix aus 1.42 geÑndert (Max, ich hatte dir das doch per Mail geschrieben!)
  ...
  - Fix: Kaputte RefZeilen (Robo: Sonst wird das wieder vergessen) fÅhren
         zum Absturz

  Revision 1.41  2001/07/23 20:44:15  rb
  bei -uz Schalter fÅr Boxname

  Revision 1.40  2001/06/26 18:35:40  rb
  Unabgesprochene énderung zurÅckgenommen
  ...
  Wenn kein charset im Header steht, wird jetzt wieder standardmÑ·ig
  ...
  Auch bei batched SMTP werden Zeilen mit einer LÑnge von mehr als
  255 Zeichen jetzt "zwangsumgebrochen" und nicht mehr abgeschnitten.

  Revision 1.22  2000/08/25 20:30:50  rb
  UnterstÅtzung fÅr X-XP-MODE eingebaut
  ...
  UUZ Erweiterungen fÅr Boxtyp PPP
