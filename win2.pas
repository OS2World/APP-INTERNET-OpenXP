...
{ --------------------------------------------------------------- }
{ $Id: win2.pas,v 1.5 2001/08/03 10:54:24 MH Exp $ }
...
begin
  ...
  if (t=keycr) and (fn<>0) then fb:=fname(p+add)
  else fb:='';
  dispose(f);
  fsbox:=fb;
end;
...
{
  $Log: win2.pas,v $
  Revision 1.5  2001/08/03 10:54:24  MH
  - Fix Absturz bei fn=0 (Keine Dateien)

  Revision 1.4  2000/04/09 18:17:42  openxp
