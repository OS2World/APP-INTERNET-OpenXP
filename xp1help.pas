...
{ --------------------------------------------------------------- }
{ $Id: xp1help.pas,v 1.5 2001/07/11 18:16:17 tj Exp $ }
...
{
  $Log: xp1help.pas,v $
  Revision 1.5  2001/07/11 18:16:17  tj
  32 Bit: F9-DOS -> F9-Shell

  Revision 1.4  2001/06/18 20:17:23  oh
  Teames -> Teams

  Revision 1.3  2000/08/27 09:29:42  MH
  Usersuche bei Auswahl Åber F2 ermîglicht

  Revision 1.2  2000/05/25 23:18:05  rb
