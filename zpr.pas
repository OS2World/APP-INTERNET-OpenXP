...
{ --------------------------------------------------------------- }
{ $Id: zpr.pas,v 1.8 2000/11/11 15:03:47 oh Exp $ }
    ...
    repeat
      ...
      if p>1 then begin
        ...
        if (fldanz<maxhdlines) or (feld='LEN') then begin
          ...
          fld[fldanz]:=s;
          inc(p);
          while (p<=length(s)) and ((s[p]=#32) or (s[p]=#9)) do inc(p);
...
{
  $Log: zpr.pas,v $
  Revision 1.8  2000/11/11 15:03:47  oh
  -Fehlende Klammer ergaenzt

  Revision 1.7  2000/10/14 16:36:58  MH
  Versionsstring geÑndert: von XP˝ auf XP2

  Revision 1.6  2000/06/08 19:22:23  MH
  Teamname geaendert

  Revision 1.5  2000/04/10 22:13:19  rb
  Code aufgerÑumt

  Revision 1.4  2000/04/09 18:34:47  openxp
