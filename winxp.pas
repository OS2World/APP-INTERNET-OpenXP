...
{ --------------------------------------------------------------- }
{ $Id: winxp.pas,v 1.9 2001/07/18 19:00:50 MH Exp $ }
...
{
  $Log: winxp.pas,v $
  Revision 1.9  2001/07/18 19:00:50  MH
  - Fixes: Compilation mit VP unter W32 wieder ermoeglicht

  Revision 1.8  2000/06/08 20:05:31  MH
  Teamname geandert

  Revision 1.7  2000/05/09 16:55:29  tj
