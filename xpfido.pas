...
{ --------------------------------------------------------------- }
{ $Id: xpfido.pas,v 1.6 2001/07/22 12:07:01 MH Exp $ }
...
begin
  ...
  while not eof(t) do begin
    ...
    if (s<>'') and (s[1]<>'#') and (s[1]<>';') and (p>0) then begin
      fn:=mid(s,p+1);
      findfirst(FidoDir+fn,DOS.Archive,sr);
...
begin       { FidoSeekfile:string;************************ }
  ...
  dialog(58,6,getres2(2120,3),x,y);     { 'Dateien suchen' }
...
{
  $Log: xpfido.pas,v $
  Revision 1.6  2001/07/22 12:07:01  MH
  - FindFirst-Attribute ge‰ndert: 0 <--> DOS.Archive

  Revision 1.5  2000/12/25 17:15:04  MH
  Filelistensuche:
  - Darstellung korrigiert

  Revision 1.4  2000/04/09 18:30:21  openxp
