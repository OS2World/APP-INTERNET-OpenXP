...
{ --------------------------------------------------------------- }
{ $Id: typeform.pas,v 1.12 2002/02/15 22:02:08 rb Exp $ }
...
{
  $Log: typeform.pas,v $
  Revision 1.12  2002/02/15 22:02:08  rb
  - einige Zeichenkonvertier- und Dekodierroutinen in neue Unit ausgelagert
  - RFC1522-Dekodierung fr Dateinamen von Attachments

  Revision 1.11  2001/06/18 20:17:20  oh
  Teames -> Teams

  Revision 1.10  2000/10/13 22:38:04  rb
  UTF-7 Support

  Revision 1.9  2000/08/13 05:10:37  MH
  RFC/PPP: Message-ID Request:
  Zur Sicherheit verwenden wir die MailString-Routine

  Revision 1.8  2000/07/16 21:44:14  tj
  Sourceheader angepasst

  Revision 1.7  2000/06/08 20:05:23  MH
  Teamname geandert

  Revision 1.6  2000/05/31 19:56:33  rb
  Assembler-Optimierungen

  Revision 1.5  2000/04/12 14:04:23  tj
  Lizenzhinweis auf XP2 angepasst

  Revision 1.4  2000/04/09 18:15:18  openxp
