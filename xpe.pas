...
{ --------------------------------------------------------------- }
{ $Id: xpe.pas,v 1.11 2000/12/26 17:38:06 MH Exp $ }
...
uses xpglobal, crt,dos,dosx,typeform,fileio,inout,keys,winxp,maus2,resource,
     maske,eddef,editor,xp0,xp1o,xp1help,xp1input,xpkeys,xp5,xp10;
...
begin
  ...
  { EdPointswitch(deutsch); }  { Ex-Yuppie-Schalter }
  EdSetUkonv(ukonv);
...
{
  $Log: xpe.pas,v $
  Revision 1.11  2000/12/26 17:38:06  MH
  Standard Zeilenumbruch auf 72 gesetzt...

  Revision 1.10  2000/11/24 19:46:57  rb
  Bugfix: C/O/I wurde im Editor nicht Åbernommen

  Revision 1.9  2000/11/16 23:46:39  rb
  EdPointSwitch ausgeklammert

  Revision 1.8  2000/07/09 08:45:45  MH
  Zeilenumbruch StandardmÑ·ig auf 72 Zeichen

  Revision 1.7  2000/07/03 02:08:24  MH
  Kleinere énderungen vorgenommen
