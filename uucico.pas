...
{ --------------------------------------------------------------- }
{ $Id: uucico.pas,v 1.5 2001/06/18 20:17:20 oh Exp $ }
...
uses  xpglobal,crt,dos,uart,typeform,fileio,video,winxp,inout,resource;
...
begin
  assign(t,''); rewrite(t);
  writeln(t);
  writeln(t,'XP UUCICO ',verstr,pformstr,betastr,teamstr,'  (c) ''93-99 by Peter Mandrella');
  writeln(t,'XP2-Version                         ',x_copyright,
...
{
 $Log: uucico.pas,v $
 Revision 1.5  2001/06/18 20:17:20  oh
 Teames -> Teams

 Revision 1.4  2001/01/04 17:09:16  MH
 - FreeRes zur Resourcenfreigabe hinzugefÅgt

 Revision 1.3  2000/10/03 20:35:33  rb
 Sourceheader angepasst

 Revision 1.2  2000/10/01 14:39:38  MH
 Versionskennung hinzugefÅgt
