...
{ --------------------------------------------------------------- }
{ $Id: xp-fm.pas,v 1.6 2000/10/14 16:36:57 MH Exp $ }
...
uses  xpglobal, crt,dos,typeform,uart,resource,fileio,xpdiff,crc16,
      montage, inout, winxp;
...
begin
  ...
  writeln(t,'XP2-Version  <',author_mail,'>          ',x_copyright,
            ' by ',author_name);
  writeln(t);
...
{
  $Log: xp-fm.pas,v $
  Revision 1.6  2000/10/14 16:36:57  MH
  Versionsstring geÑndert: von XP˝ auf XP2

  Revision 1.5  2000/04/10 22:13:07  rb
  Code aufgerÑumt

  Revision 1.4  2000/04/09 18:19:22  openxp
