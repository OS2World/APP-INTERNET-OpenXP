...
{ --------------------------------------------------------------- }
{ $Id: xpmaus.pas,v 1.5 2000/04/10 22:13:16 rb Exp $ }
...
uses xpglobal,crt,dos,typeform,fileio,keys,inout,maus2,datadef,database,stack,
     maske,xp0,xp1,xp1input,xpcrc32,xp_iti;
...
end.
{
  ...
  Revision 1.4  2000/04/09 18:31:54  openxp
