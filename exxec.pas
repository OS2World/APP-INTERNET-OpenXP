...
{ --------------------------------------------------------------- }
{ $Id: exxec.pas,v 1.6 2001/07/22 12:06:21 MH Exp $ }
...
{
  $Log: exxec.pas,v $
  Revision 1.6  2001/07/22 12:06:21  MH
  - FindFirst-Attribute ge‰ndert: 0 <--> DOS.Archive

  Revision 1.5  2000/05/12 19:40:05  oh
  -PGP und Feldtausch komplett

  Revision 1.4  2000/04/09 18:07:29  openxp
