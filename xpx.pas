...
{$IFDEF BP }            { alles andere sind sowieso 32 Bit Versionen }
  ...
  begin
    if _deutsch then begin
      Writeln('XP2 lÑuft in dieser Version erst ab 386er CPUs.');
  ...
  begin
    if _deutsch then begin
      Writeln('XP2 lÑuft in dieser Version erst ab 286er CPUs.');
      Writeln('Eine XT-Version kann von der Homepage http://www.xp2.de/ bezogen werden.');
    end
    else begin
...
end.
{
  ...
  geÑndert wurde. Funktioniert ab DOS 4.0.

  Revision 1.7  2000/09/13 21:25:34  rb
  Schalter fÅr 8088/286/386er Version
